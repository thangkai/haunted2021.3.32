...
public class Room_Controller : MonoBehaviour
{
   ...
   [SerializeField] Bool_Global_Variable m_Live_Data_Can_Build_Crucific_Tutorial;
    ...
    public bool Check_Inside_In_Room([Bridge.Ref] Vector2 pos)
    {
   ...
   [SerializeField] int m_Total_Boss_Attack;
    ...
    private void Create_Pref_Point_Line_Up([Bridge.Ref] Vector3 pos)
    {
    ...
    public bool Check_Pos_Has_Exist_In_Line_Up([Bridge.Ref] Vector3 pos)
    {
    ...
    private bool Check_Can_Line_Up([Bridge.Ref] Vector3 pos)
    {
    ...
    private Vector3 Get_New_Pos_Line_Up([Bridge.Ref] Vector3 pos_Prev, [Bridge.Ref] Vector3 pos_Curr)
    {
   ...
   [SerializeField] List<Vector3> m_Data_Pos_Line_Up = new List<Vector3>();
    ...
    public void Set_Pos_Door_Initial([Bridge.Ref] Vector3 pos_Door)
    {
