...
public class CoinEffect : MonoBehaviour
{
    ...
    private IEnumerator Animate([Bridge.Ref] Vector3 collectedCoinPosition, int startCoin, int finalCoin)
    {
            ...
            if (this.coinQueue.Count > 0)
            {
                ...
                coin.transform.DOMoveY(coin.transform.position.y - 1f, timeDown)
                    ...
                    .SetEase(Ease.InOutQuad).OnComplete(() =>
                    {
                        ...
                        Vector3 fake = this.targetPosition;
                        if (this.targetPosition == Vector3.zero)
                        {
                        
                        }
                        coin.transform.DOMove(fake, duration)
    ...
    public void AddCoins([Bridge.Ref] Vector3 collectedCoinPosition, int startCoin, int finalCoin, Action anim_Done = null)
    {
    ...
    public void AddCoins(TMP_Text _coinUIText, [Bridge.Ref] Vector3 collectedCoinPosition, int startCoin, int finalCoin, Action anim_Done = null)
    {
