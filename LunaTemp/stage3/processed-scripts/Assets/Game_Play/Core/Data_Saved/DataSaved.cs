...
public class DataSaved : Singleton<DataSaved>
{
    ...
    public static void Set_Last_Claim_Date([Bridge.Ref] DateTime dateTime)
    {
    ...
    public static void Set_Last_Time_Claim_Energy([Bridge.Ref] DateTime dateTime)
    {
    ...
    public static void Set_Last_Time_Claim_Free_Spin([Bridge.Ref] DateTime dateTime)
    {
    ...
    public static void Set_Last_Date_Show_Sale([Bridge.Ref] DateTime dateTime)
    {
    ...
    public static void Set_Last_Time_Claim_Pack_Sale([Bridge.Ref] DateTime dateTime)
    {
    ...
    public static void Set_Last_Date_Played([Bridge.Ref] DateTime dateTime)
    {
    ...
    public static void Set_Key_Pack_Iap_Appears(Type_Pack typePack, [Bridge.Ref] DateTime dateTime)
    {
    ...
    public static void Set_KEY_Last_Time_Claim_Pack_Sale_2([Bridge.Ref] DateTime dateTime)
    {
