...
//            InitPools(this.enemyPools, ref this._enemyPoolDictionary);
       ...
       //     InitPools(this.otherPools, ref this._otherPoolDictionary);
        ...
        public GameObject SpawnEnemyFromPool(int instanceID, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
        {
        ...
        public GameObject SpawnEffectFromPool(int instanceID, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
        {
        ...
        public GameObject SpawnEffectFromPool(string effectName, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
        {
        ...
        public GameObject SpawnOtherFromPool(int instanceID, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
        {
